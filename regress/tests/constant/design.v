...
//
// The repro of the most valuable bug we have found so far: the chipdb
// exporter of the previous engine built the global VCC/GND node out of
// column x=0 wires only, so a driver placed anywhere else could feed just
// its own row and `assign led = 1'b1` failed to
